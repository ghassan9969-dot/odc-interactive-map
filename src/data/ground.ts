...
export const groundCirculation: CirculationArea[] = [
  ...
  // Access beside the lifts into the women's changing/prayer suite.
  { id: 'g-circ-e-women', floor: F, polys: [rect(g, 1506, 1180, 1568, 1254)] },
  // The men's route enters beside the stair, crosses the prayer room,
  // then reaches the lockers as confirmed on the marked-up plan.
  {
    id: 'g-circ-e-men',
    floor: F,
    polys: [rect(g, 1450, 1382, 1568, 1400), rect(g, 1450, 1350, 1464, 1400)],
  },
...
export const groundLocations: Location[] = [
  ...
  },
  {
    ...
    icon: 'lift',
    shape: { polys: [rect(g, 1568, 1190, 1636, 1270)], dividers: [[g(1568, 1230), g(1636, 1230)]] },
    label: g(1602, 1230),
    labelSize: 11,
    door: g(1566, 1230),
    doorMarks: [g(1568, 1230), g(1544, 1217)],
    entryNode: 'lift34',
  ...
  /* --- Lockers and prayer rooms, east ---------------------------- */
  {
    ...
    icon: 'store',
    shape: { polys: [rect(g, 1420, 1084, 1506, 1180)] },
    label: g(1463, 1132),
    labelSize: 12,
    door: g(1508, 1160),
    doorMarks: [g(1506, 1132), g(1463, 1180)],
    entryNode: 'women_inner',
  ...
  },
  {
    ...
    icon: 'prayer',
    shape: { polys: [rect(g, 1420, 1184, 1506, 1250)] },
    label: g(1463, 1217),
    labelSize: 12,
    door: g(1508, 1217),
    doorMarks: [g(1463, 1184)],
    entryNode: 'women_inner',
    keywords: ['prayer', 'musalla', 'women', 'ladies', 'female', 'ablution'],
    primary: false,
  },
  {
    ...
    icon: 'store',
    shape: { polys: [rect(g, 1420, 1254, 1544, 1350)] },
    label: g(1482, 1302),
    labelSize: 12,
    door: g(1457, 1352),
    doorMarks: [g(1457, 1350)],
    entryNode: 'men_prayer',
  ...
  },
  {
    ...
    icon: 'prayer',
    shape: { polys: [rect(g, 1420, 1354, 1494, 1428)] },
    label: g(1457, 1391),
    labelSize: 12,
    door: g(1496, 1391),
    doorMarks: [g(1457, 1354), g(1494, 1391)],
    entryNode: 'men_entry',
    keywords: ['prayer', 'musalla', 'men', 'male', 'ablution'],
    primary: false,
  },
...
export const groundSecondary: SecondarySpace[] = [
  ...
  /* --- West amenities -------------------------------------------- */
  {
    ...
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 190, 1436, 244, 1488)] },
    label: g(217, 1462),
    labelSize: 11,
  },
  {
  ...
  /* --- East core and lockers -------------------------------------- */
  {
    ...
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 1510, 1084, 1544, 1180)] },
    label: g(1527, 1132),
    labelSize: 11,
    doorMarks: [g(1508, 1132)],
  },
  {
    id: 'g-s-toilet-e-m',
    name: 'Toilets M',
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 1498, 1354, 1544, 1428)] },
    label: g(1521, 1391),
    labelSize: 11,
...
export const groundNodes: Record<string, Pt> = {
  ...
  e_stair_w: g(1556, 1391),
  e_core_m: g(1556, 1294),
  lift34: g(1556, 1230),
  e_core_n: g(1556, 1217),
  women_inner: g(1508, 1217),
  men_entry: g(1496, 1391),
  men_prayer: g(1457, 1391),
...
export const groundEdges: [string, string][] = [
  ...
  ['e_core_m', 'lift34'],
  ['lift34', 'e_core_n'],
  ['e_core_n', 'women_inner'],
  ['e_stair_w', 'men_entry'],
  ['men_entry', 'men_prayer'],
  ['e_core_n', 'e_core_top'],
