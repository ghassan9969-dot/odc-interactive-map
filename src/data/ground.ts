...
export const groundCirculation: CirculationArea[] = [
  ...
  /* --- Patient lobby --------------------------------------------- */
  { id: 'g-circ-lobby', floor: F, polys: [rect(g, 188, 945, 388, 1215)] },
  ...
  { id: 'g-circ-west-s', floor: F, polys: [rect(g, 246, 1392, 456, 1432)] },
  ...
  { id: 'g-circ-west-amenity', floor: F, polys: [rect(g, 268, 1276, 312, 1394)] },
  ...
  { id: 'g-circ-opg', floor: F, polys: [rect(g, 442, 966, 538, 990)] },
  ...
  // open on both flanks and never blocked by the desk.
  {
    ...
    floor: F,
    polys: [
      rect(g, 442, UC_TOP, 456, UC_BOTTOM),
      rect(g, 490, UC_TOP, 510, UC_BOTTOM),
      rect(g, 456, 1256, 490, 1290),
    ],
  },
  { id: 'g-circ-uc-e', floor: F, polys: [rect(g, 1415, UC_TOP, 1435, 1490)] },

  /* --- East core, lockers and student amenities ------------------ */
  { id: 'g-circ-e-core', floor: F, polys: [rect(g, 1544, 1078, 1568, 1430)] },
  // The lift and stair block is one connected core: the space between
  // the lifts and Stair 03 is its own small landing, not a gap.
  { id: 'g-circ-e-landing', floor: F, polys: [rect(g, 1568, 1268, 1636, 1320)] },
  {
    id: 'g-circ-ss-lobby',
    floor: F,
...
export const groundLocations: Location[] = [
  ...
  /* --- Reception & information ----------------------------------- */
  {
    ...
    shape: { polys: [rect(g, 456, 1140, 490, 1250)] },
    label: g(473, 1195),
    labelSize: 13,
    door: g(473, 1138),
    doorMarks: [g(473, 1140)],
    entryNode: 'mc_uc',
  ...
  },
  {
    ...
    icon: 'reception',
    shape: { polys: [rect(g, 344, 918, 416, 988)] },
    label: g(380, 953),
    door: g(418, 953),
    entryNode: 'pg_2',
  ...
  },
  {
    ...
    icon: 'office',
    shape: { polys: [rect(g, 312, 1276, 372, 1330)] },
    label: g(342, 1303),
    labelSize: 12,
    door: g(310, 1303),
    entryNode: 'west_am',
  ...
  },
  {
    ...
    icon: 'scan',
    shape: { polys: [rect(g, 442, 840, 522, 916)] },
    label: g(482, 878),
    door: g(524, 878),
  ...
  },
  {
    ...
    icon: 'xray',
    shape: { polys: [rect(g, 442, 918, 522, 966)] },
    label: g(482, 942),
    labelSize: 15,
  ...
  },
  {
    ...
    icon: 'xray',
    shape: { polys: [rect(g, 442, 990, 522, 1038)] },
    label: g(482, 1014),
    labelSize: 15,
  ...
  },
  {
    ...
    shape: { polys: [rect(g, 196, 986, 388, 1206)] },
    label: g(292, 1020),
    labelSize: 19,
    door: g(292, 1208),
    entryNode: 'lob_a',
  ...
  },
  {
    ...
    icon: 'lift',
    shape: { polys: [rect(g, 1568, 1196, 1636, 1268)], dividers: [[g(1568, 1232), g(1636, 1232)]] },
    label: g(1602, 1232),
    labelSize: 11,
    door: g(1566, 1232),
    entryNode: 'lift34',
  ...
  },
  {
    ...
    icon: 'stairs',
    shape: { polys: [rect(g, 1568, 1320, 1636, 1400)] },
    label: g(1602, 1360),
    labelSize: 15,
  ...
  /* --- Student & staff areas ------------------------------------- */
  {
    ...
    icon: 'lounge',
    shape: { polys: [rect(g, 1568, 1104, 1636, 1200)] },
    label: g(1602, 1152),
    labelSize: 14,
    door: g(1602, 1102),
    entryNode: 'east_cross_m',
  ...
  /* --- Prayer rooms, west ---------------------------------------- */
  {
    ...
    floor: F,
    category: 'secondary',
    description: 'Prayer room for women, with its own ablution area, at the west end.',
    icon: 'prayer',
    shape: { polys: [rect(g, 246, 1436, 300, 1488)] },
    label: g(273, 1462),
    labelSize: 12,
    door: g(273, 1434),
    entryNode: 'west_s_1',
  ...
  },
  {
    ...
    floor: F,
    category: 'secondary',
    description: 'Prayer room for men, with its own ablution area, at the west end.',
    icon: 'prayer',
    shape: { polys: [rect(g, 352, 1436, 392, 1488)] },
    label: g(372, 1462),
    labelSize: 12,
    door: g(372, 1434),
    entryNode: 'west_s_2',
  ...
  {
    id: 'g-lockers-f',
    name: "Women's Lockers / Change Room",
    shortName: "Women's Lockers",
    floor: F,
    category: 'secondary',
    description: 'Locker and changing room for female students, entered from beside the lifts.',
    icon: 'store',
    shape: { polys: [rect(g, 1420, 1084, 1544, 1158)] },
    label: g(1482, 1121),
    labelSize: 12,
    door: g(1546, 1121),
    entryNode: 'e_core_n',
    keywords: ['lockers', 'changing', 'change room', 'women', 'female'],
    primary: false,
  },
  {
    id: 'g-prayer-e-f',
    name: "Women's Prayer Room (East)",
    shortName: "Women's Prayer",
    floor: F,
    category: 'secondary',
    description: 'Prayer room for women in the east wing, beside the locker rooms.',
    icon: 'prayer',
    shape: { polys: [rect(g, 1420, 1220, 1544, 1266)] },
    label: g(1482, 1243),
    labelSize: 12,
    door: g(1546, 1243),
    entryNode: 'e_core_n',
  ...
  {
    id: 'g-lockers-m',
    name: "Men's Lockers / Change Room",
    shortName: "Men's Lockers",
    floor: F,
    category: 'secondary',
    description: 'Locker and changing room for male students, in the east wing.',
    icon: 'store',
    shape: { polys: [rect(g, 1420, 1270, 1544, 1324)] },
    label: g(1482, 1297),
    labelSize: 12,
    door: g(1546, 1297),
    entryNode: 'e_core_m',
    keywords: ['lockers', 'changing', 'change room', 'men', 'male'],
    primary: false,
  },
  {
    id: 'g-prayer-e-m',
    ...
    floor: F,
    category: 'secondary',
    description: 'Prayer room for men in the east wing, entered from the east core.',
    icon: 'prayer',
    shape: { polys: [rect(g, 1420, 1328, 1544, 1388)] },
    label: g(1482, 1358),
    labelSize: 12,
    door: g(1546, 1358),
    entryNode: 'e_stair_w',
  ...
  /* --- Parking --------------------------------------------------- */
  {
    ...
    icon: 'entrance',
    shape: { polys: [rect(g, 1020, 1512, 1620, 1624)] },
    label: g(1320, 1568),
    labelSize: 22,
    door: g(1500, 1510),
    entryNode: 'ent_staff',
...
export const groundSecondary: SecondarySpace[] = [
  ...
  /* --- Imaging column -------------------------------------------- */
  technical('g-s-xray-proc', [rect(g, 442, 1080, 522, 1085)]),
  ...
  /* --- West amenities -------------------------------------------- */
  technical('g-s-janitor-w', [rect(g, 376, 1276, 392, 1330)]),
  technical('g-s-it-room', [rect(g, 456, 1322, 490, 1394)]),
  technical('g-s-tech-w', [rect(g, 456, 1398, 490, 1436)]),
  {
    id: 'g-s-toilet-w-f',
    name: 'Toilets F',
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 190, 1392, 244, 1488)] },
    label: g(217, 1440),
    labelSize: 11,
  },
  {
    ...
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 304, 1436, 348, 1488)] },
    label: g(326, 1462),
    labelSize: 11,
  },
  ...
  /* --- East core and lockers -------------------------------------- */
  {
    ...
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 1420, 1162, 1544, 1216)] },
    label: g(1482, 1189),
    labelSize: 11,
  },
  {
    ...
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 1420, 1392, 1544, 1428)] },
    label: g(1482, 1410),
    labelSize: 11,
  },
  {
    id: 'g-s-toilet-canteen',
    name: 'Toilets',
    floor: F,
    kind: 'toilet',
    shape: { polys: [rect(g, 1640, 1104, 1690, 1160)] },
    label: g(1665, 1132),
    labelSize: 11,
  },
  technical('g-s-east-tech', [rect(g, 1500, 1430, 1544, 1490)]),
...
export const groundNodes: Record<string, Pt> = {
  ...
  core_w2: g(346, 1310),
  west_am: g(290, 1310),
  west_s_mid: g(346, 1412),
  stair01_s: g(424, 1412),
  west_s_1: g(273, 1412),
  west_s_2: g(372, 1412),
  mc_uw: g(449, 1100),
  uc_w_a: g(449, 1160),
  ...
  e_core_s: g(1556, 1412),
  e_stair_w: g(1556, 1358),
  e_core_m: g(1556, 1294),
  lift34: g(1556, 1232),
  e_core_n: g(1556, 1121),
  e_core_top: g(1556, 1089),
  ...
  /* Parking, outside the south facade */
  park_in: g(1500, 1520),
