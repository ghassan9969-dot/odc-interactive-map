...
const P: Record<IconType, string[]> = {
  ...
  prayer: ['M7 21V11.5a5 5 0 0 1 10 0V21z', 'M9.9 21v-9a2.1 2.1 0 0 1 4.2 0v9'],
  ...
  parking: ['M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z', 'M10 17.5V6.5h3.4a3 3 0 0 1 0 6H10'],
